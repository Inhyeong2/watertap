...
def main(state="FL", treatment_train="RBAT", effluent_type="TERTIARY"):
    ...
    set_operating_conditions(m, flow_vol=100*0.0438, solute_list=solute_list, treatment_train=treatment_train)
...
def build_RO(working_directory="local", state=None, solute_list=None, effluent_type=None, LRVO3_req=None, LRVClvirus_req=None, LRVClgiardia_req=None):
    ...
    def eq_flow_vol_main_post(blk):
        return blk.properties_out[0].flow_vol == RO_main.RO.feed_side.properties_out[0].flow_vol_phase["Liq"]
