...
def display_results_RO_DPR(m):
    ...
    print(f"Flow rate of inlet of img_sep: {value(pyunits.convert(m.fs.RO_sep.img_sep.properties_in[0].flow_vol, to_units=pyunits.m ** 3 / pyunits.hr)): .3f} m3/hr")

    print(
        f"Flow rate of inlet1 (img_sep) to tb1: {value(pyunits.convert(m.fs.RO_sep.img_sep.properties_treated[0].flow_vol, to_units=pyunits.m ** 3 / pyunits.hr)): .3f} m3/hr")
    print(
        f"Flow rate of inlet1 (img_sep) to img_mix: {value(pyunits.convert(m.fs.RO_sep.img_sep.properties_byproduct[0].flow_vol, to_units=pyunits.m ** 3 / pyunits.hr)): .3f} m3/hr")
    ...
    print(f"Flow rate of inlet1 (img_sep) of img_mix: {value(pyunits.convert(m.fs.RO_mix.img_mix.properties_in1[0].flow_vol, to_units=pyunits.m ** 3 / pyunits.hr)): .3f} m3/hr")
    print(f"Flow rate of input2 (tb2) of img_mixer: {value(pyunits.convert(m.fs.RO_mix.img_mix.properties_in2[0].flow_vol, to_units=pyunits.m ** 3 / pyunits.hr)): .3f} m3/hr")
    print(f"Flow rate after img_mixer: {value(pyunits.convert(m.fs.RO_mix.img_mix.properties_treated[0].flow_vol, to_units=pyunits.m ** 3 / pyunits.hr)): .3f} m3/hr")
    ...
    print(
        f"TOC after imaginary mixer: {value(pyunits.convert(m.fs.RO_mix.img_mix.properties_treated[0].conc_mass_comp['toc'], to_units=pyunits.mg / pyunits.L)): .3f} mg/L")
