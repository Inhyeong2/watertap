...
# cascade + permeate mixer). N_STAGES=1 reproduces the single-stage spiral sweep exactly.
N_STAGES = 3

TAG = f"ROspiral_add_const_n{N_STAGES}"  # stage-specific tag so multi-stage MC results do not overwrite single-stage ones
